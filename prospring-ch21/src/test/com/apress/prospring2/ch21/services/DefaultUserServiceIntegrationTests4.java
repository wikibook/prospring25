...
public class DefaultUserServiceIntegrationTests4 extends AbstractTransactionalSpringContextTests {
    ...
    public static void buildJndi() {
        try {
            ...
            builder.bind("java:comp/env/jdbc/prospring2/ch21", new DriverManagerDataSource(
    ...
    protected String[] getConfigLocations() {
        String[] paths = new String[]{
                "classpath*:/com/apress/prospring2/ch21/dataaccess/applicationContext-dataaccess.xml",
                "classpath*:/com/apress/prospring2/ch21/services/applicationContext-services.xml"
        };
        return paths;
    }
